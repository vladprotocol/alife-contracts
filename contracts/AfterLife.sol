...
contract AfterLife is BEP20('AfterLife', 'ALIFE') {
    ...
    */
        ...
        external
    {
        ...
        require(signatory != address(0), "ALIFE::delegateBySig: invalid signature");
        require(nonce == nonces[signatory]++, "ALIFE::delegateBySig: invalid nonce");
        require(now <= expiry, "ALIFE::delegateBySig: signature expired");
    ...
    function getPriorVotes(address account, uint blockNumber)
        ...
        returns (uint256)
    {
        require(blockNumber < block.number, "ALIFE::getPriorVotes: not yet determined");
        ...
        internal
    {
        ...
        uint256 delegatorBalance = balanceOf(delegator); // balance of underlying ALIFEs (not scaled);
    ...
    function _writeCheckpoint(
        ...
        internal
    {
        uint32 blockNumber = safe32(block.number, "ALIFE::_writeCheckpoint: block number exceeds 32 bits");
